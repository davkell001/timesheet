...
namespace MBTimeSheetWebApp.Account
{
    public partial class TwoFactorAuthenticationSignIn : System.Web.UI.Page
    {
        ...
        protected async void CodeSubmit_Click(object sender, EventArgs e)
        {
            bool rememberMe = false;
            bool.TryParse(Request.QueryString["RememberMe"], out rememberMe);
            SignInHelper helper = new SignInHelper(manager, AuthenticationManager);
            ...
            var result = await helper.TwoFactorSignIn(SelectedProvider.Value, Code.Text, isPersistent: rememberMe, rememberBrowser: RememberBrowser.Checked);
